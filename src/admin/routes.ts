...
function renderAdminPage(products: Awaited<ReturnType<typeof listAdminProducts>>, databaseConfigured: boolean): string {
...
export function createAdminRouter() {
  ...
  router.get(
    ...
    asyncHandler(async (_request, response) => {
      ...
      response.send(renderAdminPage(products, databaseConfigured));
    }),
  );
